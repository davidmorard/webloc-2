...
return array(
    ...
    "FEEDBACK_ACCOUNT_TYPE_CHANGE_SUCCESSFUL" => "Le type de votre compte a été modifié avec succès",
    "FEEDBACK_ACCOUNT_TYPE_CHANGE_FAILED" => "La modification de votre compte a échoué",
